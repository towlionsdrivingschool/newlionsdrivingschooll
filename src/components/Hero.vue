    ...
    <div class="grid place-items-center lg:max-w-screen-xl gap-8 mx-auto py-20 md:py-32">
      <div class="text-center space-y-8">
        <Badge variant="outline" class="text-sm py-2">
          ...
          <span> government approved driving school </span>
        </Badge>

        <div class="max-w-screen-md mx-auto text-center text-5xl md:text-6xl font-bold">
          <h1>
            New Lions
            <span class="text-transparent bg-gradient-to-r from-[rgb(93,127,236)] to-primary bg-clip-text">Driving
              School
            </span>
        ...
        <p class="max-w-screen-sm mx-auto text-xl text-muted-foreground">
          New Lions Driving School <br> is a best driving school in
          in Kuttanad
        </p>

        <div class="space-y-4 md:space-y-0 md:space-x-4">
          <Button class="w-5/6 md:w-1/4 font-bold group/arrow bg-red-600">
            <a href="https://wa.me/+918848481408" target="_blank" rel="noopener noreferrer">
              Book Now
            </a>
          ...
          <Button as-child variant="secondary" class="w-5/6 md:w-1/4 font-bold">
            <a href="https://www.rtoexam.com/kerala/ml" target="_blank" rel="noopener noreferrer">
              Learners Test
              Practice
            </a>
